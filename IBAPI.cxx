...
#if IB_API_INTVER >= 969
void IBAPIClient::position( const IBString& account, const Contract& contract, int position )
{
#ifdef DEBUG
...
void IBAPIClient::positionEnd()
{
#ifdef DEBUG
    std::cout << "C++ positionEnd()" << std::endl;
#endif
    perl_call_va( "Finance::InteractiveBrokers::SWIG::_event_dispatcher",
                  "s", "positionEnd",
                  NULL );
...
void IBAPIClient::accountSummary( int reqId, const IBString& account, const IBString& tag, const IBString& value, const IBString& curency)
{
#ifdef DEBUG
    std::cout << "C++ accountSummary()" << std::endl;
#endif
    perl_call_va( "Finance::InteractiveBrokers::SWIG::_event_dispatcher",
                  "s", "accountSummary",
                  "i", reqId,
...
void IBAPIClient::accountSummaryEnd( int reqId)
{
#ifdef DEBUG
    std::cout << "C++ accountSummaryEnd()" << std::endl;
#endif
    perl_call_va( "Finance::InteractiveBrokers::SWIG::_event_dispatcher",
                  "s", "accountSummaryEnd",
                  "i", reqId,
